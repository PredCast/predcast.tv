...
"[project]/node_modules/.pnpm/@thumbmarkjs+thumbmarkjs@0.16.0/node_modules/@thumbmarkjs/thumbmarkjs/dist/thumbmark.esm.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
__turbopack_context__.s({
    "getFingerprint": (()=>g),
    "getFingerprintData": (()=>v),
    "getFingerprintPerformance": (()=>w),
    "getVersion": (()=>N),
    "setOption": (()=>t)
});
function e(e, r, n, t) {
...
function t(e, r) {
    if (![
        ...
        "retries",
        "timeout"
    ].includes(e)) throw new Error("Unknown option " + e);
    if ([
        "exclude",
        "permissions_to_check"
    ].includes(e) && (!Array.isArray(r) || !r.every(function(e) {
        return "string" == typeof e;
    }))) throw new Error("The value of the exclude and permissions_to_check must be an array of strings");
    if ([
        "retries",
        "timeout"
    ].includes(e) && "number" != typeof r) throw new Error("The value of retries must be a number");
    n[e] = r;
}
var o = {}, a = {
    timeout: "true"
...
function f(e, r) {
    ...
    !function(e, r) {
        ...
        var n = e.byteLength / 16 | 0, t = e.byteLength % 16, o = new Uint32Array(4), a = new Uint8Array(e, 16 * n, t);
        switch(t){
            case 15:
                o[3] = o[3] ^ a[14] << 16;
            case 14:
            ...
            switch(r.label){
                case 0:
                    return r.trys.push([
                        ...
                        4,
                        m(Object.values(e), (null == n ? void 0 : n.timeout) || 1e3, a)
                    ];
                case 1:
...
function p(e, r) {
    var n = {}, t = function(t) {
        if (e.hasOwnProperty(t)) {
            var o = e[t];
            if ("object" != typeof o || Array.isArray(o)) r.includes(t) || (n[t] = o);
            else {
    ...
    return e(this, void 0, void 0, function() {
        ...
        return r(this, function(r) {
            switch(r.label){
                ...
                case 1:
                    return e = r.sent(), t = f(JSON.stringify(e)), n ? [
                        2,
                        {
                            hash: t.toString(),
                            data: e
            ...
            switch(r.label){
                case 0:
                    return r.trys.push([
                        ...
                        4,
                        h(Object.values(e), (null == n ? void 0 : n.timeout) || 1e3, a)
                    ];
                case 1:
                    return o = r.sent(), i = {
                        elapsed: {}
        ...
        return r(this, function(e) {
            return [
                ...
                new Promise(function(e, r) {
                    try {
                        var n = new (window.OfflineAudioContext || window.webkitOfflineAudioContext)(1, 5e3, 44100), t = n.createBufferSource(), o = n.createOscillator();
                        o.frequency.value = 1e3;
                        var a, i = n.createDynamicsCompressor();
...
function R() {
    var e, r, n, t, o = document.createElement("canvas"), a = null !== (e = o.getContext("webgl")) && void 0 !== e ? e : o.getContext("experimental-webgl");
...
function I() {
    var e = new Float32Array(1), r = new Uint8Array(e.buffer);
...
"Firefox" != M().name && i("fonts", function() {
        ...
        try {
            !function(n) {
                ...
                return e(n, void 0, void 0, function() {
                    var e, n, o, i;
                    return r(this, function(r) {
                        return e = a.createElement("canvas"), n = e.getContext("2d"), o = T.map(function(e) {
                            return k(n, e);
    ...
    return new Promise(function(e, r) {
        var n = void 0 !== navigator.deviceMemory ? navigator.deviceMemory : 0, t = window.performance && window.performance.memory ? window.performance.memory : 0;
        e({
            videocard: R(),
            architecture: I(),
    ...
    return e(this, void 0, void 0, function() {
        ...
        return r(this, function(o) {
            return C = (null == n ? void 0 : n.permissions_to_check) || [
                "accelerometer",
                "accessibility",
                    ...
                    return e(this, void 0, void 0, function() {
                        ...
                        return r(this, function(r) {
                            switch(r.label){
                                ...
                                case 3:
                                    return a = r.sent(), e[o] = a.state.toString(), [
                                        3,
                                        5
                                    ];
                                case 4:
...
var D, B = "SamsungBrowser" !== M().name ? 1 : 3, U = null;
i("webgl", function() {
    return e(this, void 0, void 0, function() {
        var e;
        return r(this, function(r) {
...
//# sourceMappingURL=bff81_%40thumbmarkjs_thumbmarkjs_dist_thumbmark_esm_0613e67a.js.map